    ...
    return(
        <div className={"user-profil-page-data-div-desktop"}>
            ...
            <div className={'user-profil-change-data-div-desktop'}>
                <span><Link to={ROUTER_PATH.CHANGE_PHONE}>Change User Phone Number &#128241;</Link></span>
                <span><Link to={ROUTER_PATH.CHANGE_EMAIL}>Change User Email &#128232;</Link></span>
                <span><Link to={ROUTER_PATH.CHANGE_PASSWORD}>Change User Password &#128272;</Link></span>
            </div>
        </div>
    )
}
